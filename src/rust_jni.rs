...
#[no_mangle]
pub extern "system" fn Java_com_troy_chess_Natives_init0(_env: JNIEnv, _class: JClass) {}


#[no_mangle]
pub extern "system" fn Java_com_troy_chess_Natives_startGame(env: JNIEnv, _class: JClass, ja_name: JString, jb_name: JString, game_type_java: JString) {
